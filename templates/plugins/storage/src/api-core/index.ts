...
export const registerCoreRoutes = (app: Express): void => {
  ...
  console.log(
    '📋 Core routes registered: /health, /auth/*, /api/health, /api/test-error, /api/pages/*, /api/users/:id/presence, /api/notifications*, /api/users*, /api/settings*, /api/blog*, /api/profile*, /api/storage*'
  );
};
