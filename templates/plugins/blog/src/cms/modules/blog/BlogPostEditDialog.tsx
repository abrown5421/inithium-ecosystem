...
import { Box, Button, IconButton, Input, Text, Textarea } from '@inithium/ui';
import { useCreateBlogPostMutation, useUpdateBlogPostMutation } from '@inithium/api-client';
  ...
  return (
    <Box flex={{ direction: 'col', gap: 16 }}>
      ...
      <Box flex={{ direction: 'row', gap: 12 }}>
        ...
        <Input label="Image URL" value={image} onChange={(event) => setImage(event.target.value)} className="flex-1" />
      </Box>
      <Textarea
        label="Excerpt"
